    ...
    public OpenAPI netdiskOpenAPI() {
        return new OpenAPI()
                .info(new Info().title("网盘项目 API")
                        .description("基于springboot + vue 框架开发的Web文件系统")
                        .version("v1.0.0")
                        .license(new License().name("MIT").url("http://springdoc.org")))
                .externalDocs(new ExternalDocumentation()
                        .description("项目github地址")
                        .url("https://github.com/Oxyw/NetDisk-Project"));
    }
*/
    ...
    private ApiInfo apiInfo() {
        Contact contact = new Contact("wxy", "https://github.com/Oxyw/NetDisk-Project","[email protected]");
